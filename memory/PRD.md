...
- [x] **KPI DSO** : (Comptes clients courants hors retenues ÷ Ventes des 12 derniers mois réels) × 365. Base glissante 12 mois (pas d'annualisation YTD). Numérateur = Comptes à recevoir − retenues contractuelles ; dénominateur = ventes 12 mois NON ajustées. Nécessite 12 mois verrouillés, sinon message « non calculable de façon fiable ». Juin 2026 : 93,1 j.
- [x] **KPI DPO** : (Comptes fournisseurs ÷ Achats des 12 derniers mois réels) × 365. Achats = COGS 12 mois glissants + variation d'inventaire sur 12 mois (Inv fin − Inv il y a 12 mois). Base glissante 12 mois (pas d'annualisation YTD) ; nécessite 12 mois de données verrouillées, sinon message « non calculable de façon fiable — X/12 mois disponibles ».
