...
- [x] **Colonne « Grand livre »** dans le tableau des Périodes : badge vert ✓ + nombre de transactions par mois (ou « — » si absent), alimenté par `ledger_count`. Vérifié visuellement (Janvier 2026 : ✓ 5 242).
