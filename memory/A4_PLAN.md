...
- [ ] A4.2 Facture fournisseur + posting canonique · A4.3 Paiements + Aging · A4.4 Boîte de réception + IA (GATE gouvernance) · A4.5 PO minimal + matching 2-way + règle PO · A4.6 Matrice d'approbation · A4.7 Courriel AP entrant · A4.8 Réception + 3-way (différé).
